...
Source0: https://github.com/rthalley/dnspython/archive/v%{version}.tar.gz
...
%changelog
* Fri Mar 19 2021 Antonio Huete <ahuete@evicertia.com> - 2.1.0-1
- Updated to 2.1.0

* Mon Oct 28 2019 Avram Lubkin <aviso@fedoraproject.org> - 1.16.0-1
- Updated to 1.16.0

* Thu Mar 07 2019 Troy Dawson <tdawson@redhat.com> - 1.15.0-8
- Rebuilt to change main python from 3.4 to 3.6

* Tue Jan 09 2018 Avram Lubkin <aviso@fedoraproject.org> - 1.15.0-7
- Remove default file permissions

* Tue Jan 09 2018 Avram Lubkin <aviso@fedoraproject.org> - 1.15.0-6
- Cleanup spec file for el7 review
